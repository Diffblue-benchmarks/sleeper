...
import sleeper.clients.docker.stack.CompactionDockerStack.Builder;
...
class CompactionDockerStackDiffblueTest {
  /**
   * Test {@link CompactionDockerStack#tearDown()}.
   * <p>
   * Method under test: {@link CompactionDockerStack#tearDown()}
   */
  @Test
  @DisplayName("Test tearDown()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void CompactionDockerStack.tearDown()"})
  void testTearDown() throws AwsServiceException, SdkClientException {
    ...
    Builder dynamoDBResult = CompactionDockerStack.builder().dynamoDB(dynamoDB);
    ...
    CompactionDockerStack buildResult = instancePropertiesResult.sqsClient(sqsClient).build();
  ...
  void testTearDown_givenInstancePropertiesGetBooleanReturnFalse_thenCallsGetBoolean()
    ...
    Builder instancePropertiesResult = CompactionDockerStack.builder()
