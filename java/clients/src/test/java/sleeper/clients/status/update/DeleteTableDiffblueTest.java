...
class DeleteTableDiffblueTest {
  /**
   * Test {@link DeleteTable#DeleteTable(AmazonS3, AmazonDynamoDB, InstanceProperties)}.
   * <ul>
   *   <li>Given {@code true}.</li>
   *   <li>Then calls {@link SleeperPropertyValues#getBoolean(SleeperProperty)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DeleteTable#DeleteTable(AmazonS3, AmazonDynamoDB, InstanceProperties)}
   */
  @Test
  @DisplayName("Test new DeleteTable(AmazonS3, AmazonDynamoDB, InstanceProperties); given 'true'; then calls getBoolean(SleeperProperty)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void DeleteTable.<init>(AmazonS3, AmazonDynamoDB, InstanceProperties)"})
  void testNewDeleteTable_givenTrue_thenCallsGetBoolean() {
    // Arrange
    ...
    // Act
    new DeleteTable(s3Client, dynamoDB, instanceProperties);
