...
import sleeper.core.tracker.ingest.task.IngestTaskFinishedStatus.Builder;
import sleeper.core.tracker.job.run.JobRunSummary;
import sleeper.core.tracker.job.run.JobRunTime;
import sleeper.core.tracker.job.run.RecordsProcessed;

class IngestTaskFinishedStatusDiffblueTest {
  /**
  ...
  void testBuilderAddJobSummary() {
    // Arrange
    Builder builderResult = IngestTaskFinishedStatus.builder();
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"IngestTaskFinishedStatus Builder.build()", "Builder Builder.finishTime(Instant)",
  ...
  void testBuilderBuild() {
    ...
    // Act
    IngestTaskFinishedStatus actualBuildResult = builderResult
  ...
  void testBuilderFinish() {
    ...
    // Assert
    IngestTaskFinishedStatus buildResult = builderResult.build();
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link IngestTaskFinishedStatus#toString()}
   *   <li>{@link IngestTaskFinishedStatus#getFinishTime()}
   *   <li>{@link IngestTaskFinishedStatus#getRecordsReadPerSecond()}
   *   <li>{@link IngestTaskFinishedStatus#getRecordsWrittenPerSecond()}
   *   <li>{@link IngestTaskFinishedStatus#getTimeSpentOnJobs()}
   *   <li>{@link IngestTaskFinishedStatus#getTotalJobRuns()}
   *   <li>{@link IngestTaskFinishedStatus#getTotalRecordsRead()}
   *   <li>{@link IngestTaskFinishedStatus#getTotalRecordsWritten()}
   * </ul>
   */
  @Test
  @DisplayName("Test getters and setters")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"Instant IngestTaskFinishedStatus.getFinishTime()",
      "double IngestTaskFinishedStatus.getRecordsReadPerSecond()",
      "double IngestTaskFinishedStatus.getRecordsWrittenPerSecond()",
      "Duration IngestTaskFinishedStatus.getTimeSpentOnJobs()", "int IngestTaskFinishedStatus.getTotalJobRuns()",
      "long IngestTaskFinishedStatus.getTotalRecordsRead()", "long IngestTaskFinishedStatus.getTotalRecordsWritten()",
      "String IngestTaskFinishedStatus.toString()"})
  void testGettersAndSetters() {
    // Arrange
    Builder builderResult = IngestTaskFinishedStatus.builder();
    IngestTaskFinishedStatus buildResult = builderResult
        .finishTime(LocalDate.of(1970, 1, 1).atStartOfDay().atZone(ZoneOffset.UTC).toInstant())
        .recordsReadPerSecond(10.0d)
        .recordsWrittenPerSecond(10.0d)
        .timeSpentOnJobs(TransactionLogStateStore.DEFAULT_TIME_BETWEEN_SNAPSHOT_CHECKS)
    ...
    // Assert
    assertEquals(
        "IngestTaskFinishedStatus{finishTime=1970-01-01T00:00:00Z, totalJobs=1, timeSpentOnJobs=PT1M,"
  ...
  /**
   * Test {@link IngestTaskFinishedStatus#asSummary(Instant)}.
   * <p>
   * Method under test: {@link IngestTaskFinishedStatus#asSummary(Instant)}
   */
  @Test
  @DisplayName("Test asSummary(Instant)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"JobRunSummary IngestTaskFinishedStatus.asSummary(Instant)"})
  void testAsSummary() {
    // Arrange
    Builder builderResult = IngestTaskFinishedStatus.builder();
    IngestTaskFinishedStatus buildResult = builderResult
  ...
  /**
   * Test {@link IngestTaskFinishedStatus#equals(Object)}, and {@link IngestTaskFinishedStatus#hashCode()}.
   * <ul>
   ...
   * Methods under test:
   * <ul>
   *   <li>{@link IngestTaskFinishedStatus#equals(Object)}
   *   <li>{@link IngestTaskFinishedStatus#hashCode()}
   * </ul>
   */
  @Test
  @DisplayName("Test equals(Object), and hashCode(); when other is equal; then return equal")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"boolean IngestTaskFinishedStatus.equals(Object)", "int IngestTaskFinishedStatus.hashCode()"})
  void testEqualsAndHashCode_whenOtherIsEqual_thenReturnEqual() {
    ...
    IngestTaskFinishedStatus buildResult = builderResult
        ...
        .totalRecordsWritten(1L)
        .build();
    Builder builderResult2 = IngestTaskFinishedStatus.builder();
    IngestTaskFinishedStatus buildResult2 = builderResult2
        .finishTime(LocalDate.of(1970, 1, 1).atStartOfDay().atZone(ZoneOffset.UTC).toInstant())
        .recordsReadPerSecond(10.0d)
        .recordsWrittenPerSecond(10.0d)
        .timeSpentOnJobs(TransactionLogStateStore.DEFAULT_TIME_BETWEEN_SNAPSHOT_CHECKS)
  ...
  /**
   * Test {@link IngestTaskFinishedStatus#equals(Object)}.
   * <ul>
   *   <li>When other is different.</li>
   *   <li>Then return not equal.</li>
   * </ul>
   * <p>
   * Method under test: {@link IngestTaskFinishedStatus#equals(Object)}
   */
  @Test
  ...
  void testEquals_whenOtherIsWrongType_thenReturnNotEqual() {
    ...
    // Act and Assert
    assertNotEquals(buildResult, "Different type to IngestTaskFinishedStatus");
  }
}
