...
class GarbageCollectionPropertyDiffblueTest {
  /**
   * Test {@link GarbageCollectionProperty#getAll()}.
   * <p>
   * Method under test: {@link GarbageCollectionProperty#getAll()}
   */
  @Test
  @DisplayName("Test getAll()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"List GarbageCollectionProperty.getAll()"})
  void testGetAll() {
    // Arrange and Act
    List<UserDefinedInstanceProperty> actualAll = GarbageCollectionProperty.getAll();
