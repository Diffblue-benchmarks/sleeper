...
class BatcherPropertyDiffblueTest {
  /**
   * Test {@link BatcherProperty#getAll()}.
   * <p>
   * Method under test: {@link BatcherProperty#getAll()}
   */
  @Test
  @DisplayName("Test getAll()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"List BatcherProperty.getAll()"})
  void testGetAll() {
    // Arrange and Act
    List<UserDefinedInstanceProperty> actualAll = BatcherProperty.getAll();
