...
class AthenaPropertyDiffblueTest {
  /**
   * Test {@link AthenaProperty#getAll()}.
   * <p>
   * Method under test: {@link AthenaProperty#getAll()}
   */
  @Test
  @DisplayName("Test getAll()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"List AthenaProperty.getAll()"})
  void testGetAll() {
    // Arrange and Act
    List<UserDefinedInstanceProperty> actualAll = AthenaProperty.getAll();
