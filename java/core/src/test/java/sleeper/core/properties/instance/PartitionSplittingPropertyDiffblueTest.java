...
class PartitionSplittingPropertyDiffblueTest {
  /**
   * Test {@link PartitionSplittingProperty#getAll()}.
   * <p>
   * Method under test: {@link PartitionSplittingProperty#getAll()}
   */
  @Test
  @DisplayName("Test getAll()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"List PartitionSplittingProperty.getAll()"})
  void testGetAll() {
    // Arrange and Act
    List<UserDefinedInstanceProperty> actualAll = PartitionSplittingProperty.getAll();

    // Assert
    assertEquals(11, actualAll.size());
