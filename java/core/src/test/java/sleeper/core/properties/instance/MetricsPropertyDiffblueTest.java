...
class MetricsPropertyDiffblueTest {
  /**
   * Test {@link MetricsProperty#getAll()}.
   * <p>
   * Method under test: {@link MetricsProperty#getAll()}
   */
  @Test
  @DisplayName("Test getAll()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"List MetricsProperty.getAll()"})
  void testGetAll() {
    // Arrange and Act
    List<UserDefinedInstanceProperty> actualAll = MetricsProperty.getAll();
