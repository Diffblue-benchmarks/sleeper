...
class PersistentEMRPropertyDiffblueTest {
  /**
   * Test {@link PersistentEMRProperty#getAll()}.
   * <p>
   * Method under test: {@link PersistentEMRProperty#getAll()}
   */
  @Test
  @DisplayName("Test getAll()")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"List PersistentEMRProperty.getAll()"})
  void testGetAll() {
    // Arrange and Act
    List<UserDefinedInstanceProperty> actualAll = PersistentEMRProperty.getAll();

    // Assert
    assertEquals(10, actualAll.size());
