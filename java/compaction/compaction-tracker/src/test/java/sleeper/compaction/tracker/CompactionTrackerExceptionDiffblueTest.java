...
class CompactionTrackerExceptionDiffblueTest {
   ...
   *
   * <p>Method under test: {@link CompactionTrackerException#CompactionTrackerException(String,
   * Throwable)}
   */
  @Test
  ...
  void testNewCompactionTrackerException() {
    ...
    // Act
    CompactionTrackerException actualCompactionTrackerException =
        new CompactionTrackerException("An error occurred", cause);
