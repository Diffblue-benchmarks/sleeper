...
class DynamoDBCompactionTaskTrackerCreatorDiffblueTest {
   ...
   * <ul>
   *   <li>Given {@code false}.
   *   <li>When {@link InstanceProperties} {@link InstanceProperties#getBoolean(SleeperProperty)}
   *       return {@code false}.
   * </ul>
   *
   * <p>Method under test: {@link DynamoDBCompactionTaskTrackerCreator#create(InstanceProperties,
   * AmazonDynamoDB)}
   */
  @Test
  @DisplayName(
      "Test create(InstanceProperties, AmazonDynamoDB); given 'false'; when InstanceProperties getBoolean(SleeperProperty) return 'false'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void DynamoDBCompactionTaskTrackerCreator.create(InstanceProperties, AmazonDynamoDB)"
  })
   ...
   *
   * <ul>
   *   <li>Then calls {@link AmazonDynamoDBAsyncClient#createTable(CreateTableRequest)}.
   * </ul>
   *
   * <p>Method under test: {@link DynamoDBCompactionTaskTrackerCreator#create(InstanceProperties,
   * AmazonDynamoDB)}
  ...
  @Test
  @DisplayName(
      "Test create(InstanceProperties, AmazonDynamoDB); then calls createTable(CreateTableRequest)")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void DynamoDBCompactionTaskTrackerCreator.create(InstanceProperties, AmazonDynamoDB)"
  ...
  void testCreate_thenCallsCreateTable() {
    ...
    when(dynamoDB.updateTimeToLive(Mockito.<UpdateTimeToLiveRequest>any()))
        .thenReturn(new UpdateTimeToLiveResult());
