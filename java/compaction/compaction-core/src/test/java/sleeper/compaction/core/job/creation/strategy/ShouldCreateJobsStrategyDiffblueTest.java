...
class ShouldCreateJobsStrategyDiffblueTest {
   ...
   *
   * <p>Method under test: {@link ShouldCreateJobsStrategy#yes()}
   */
  @Test
  ...
  void testYes() {
    ...
    long actualMaxCompactionJobsToCreateResult =
        actualYesResult.maxCompactionJobsToCreate(filesInPartition);

    // Assert
    assertEquals(Long.MAX_VALUE, actualMaxCompactionJobsToCreateResult);
  }
}
