...
class SizeRatioLeafStrategyDiffblueTest {
  /**
   * Test {@link SizeRatioLeafStrategy#init(InstanceProperties, TableProperties, CompactionJobFactory)}.
   * <ul>
   *   <li>Given one.</li>
   ...
   * </ul>
   * <p>
   * Method under test: {@link SizeRatioLeafStrategy#init(InstanceProperties, TableProperties, CompactionJobFactory)}
   */
  @Test
  ...
  @MethodsUnderTest({"void SizeRatioLeafStrategy.init(InstanceProperties, TableProperties, CompactionJobFactory)"})
  void testInit_givenOne_whenTablePropertiesGetIntReturnOne_thenCallsGetInt() {
    ...
    // Act
    sizeRatioLeafStrategy.init(instanceProperties, tableProperties,
   ...
   * <p>
   * Method under test: {@link SizeRatioLeafStrategy#createJobsForLeafPartition(FilesInPartition)}
   */
  @Test
  ...
  void testCreateJobsForLeafPartition() {
    ...
    // Act
    List<CompactionJob> actualCreateJobsForLeafPartitionResult = sizeRatioLeafStrategy
  ...
  void testCreateJobsForLeafPartition2() {
    ...
    FileReference buildResult3 = jobIdResult3
        ...
        .partitionId("42")
        .build();
    fileReferenceList.add(buildResult3);
    FilesInPartition filesInPartition = mock(FilesInPartition.class);
    when(filesInPartition.getPartitionId()).thenReturn("42");
    when(filesInPartition.getFilesWithNoJobIdInAscendingOrder()).thenReturn(fileReferenceList);
