...
public class CompactionJobBatchExpiredExceptionTest {

    InstanceProperties instanceProperties = createTestInstanceProperties();
    TableProperties tableProperties = createTestTablePropertiesWithNoSchema(instanceProperties);

    @Test
    void shouldIncludeTableIdAndExpiryTimeAndBatchKeyInMessage() {
        // Given
        ...
        Instant expiryTime = Instant.parse("2024-11-18T12:30:00Z");
        ...
        assertThat(exception.getMessage())
                .contains("test-table")
                .contains("2024-11-18T12:30:00Z")
                .contains(request.getBatchKey());
    }
}
