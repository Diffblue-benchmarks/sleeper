...
public class CompactionJobBatchExpiredExceptionTest {
    ...
    @Test
    void shouldConstructExceptionMessageWithTableIdBatchKeyAndExpiryTime() {
        // Given
        ...
        Instant expiryTime = Instant.parse("2024-11-18T13:01:00Z");
