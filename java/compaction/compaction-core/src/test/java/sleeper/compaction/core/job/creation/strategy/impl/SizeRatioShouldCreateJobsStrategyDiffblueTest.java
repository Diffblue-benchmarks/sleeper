...
class SizeRatioShouldCreateJobsStrategyDiffblueTest {
   ...
   * <ul>
   *   <li>Then return {@code 2147483647}.</li>
   * </ul>
   * <p>
   * Method under test: {@link SizeRatioShouldCreateJobsStrategy#maxCompactionJobsToCreate(CompactionStrategyIndex.FilesInPartition)}
   */
  @Test
  ...
  void testMaxCompactionJobsToCreate_thenReturn2147483647() {
    // Arrange
    SizeRatioShouldCreateJobsStrategy sizeRatioShouldCreateJobsStrategy = new SizeRatioShouldCreateJobsStrategy();
    InstanceProperties instanceProperties = new InstanceProperties();
    sizeRatioShouldCreateJobsStrategy.init(instanceProperties, new TableProperties(new InstanceProperties()));
    ...
    // Act
    long actualMaxCompactionJobsToCreateResult = sizeRatioShouldCreateJobsStrategy
        .maxCompactionJobsToCreate(filesInPartition);
