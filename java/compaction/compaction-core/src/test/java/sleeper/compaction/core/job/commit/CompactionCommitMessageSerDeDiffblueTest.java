...
class CompactionCommitMessageSerDeDiffblueTest {
   ...
   * <p>
   * Method under test: default or parameterless constructor of {@link CompactionCommitMessageSerDe}
   */
  @Test
  ...
  void testNewCompactionCommitMessageSerDe() {
    // Arrange and Act
    CompactionCommitMessageSerDe actualCompactionCommitMessageSerDe = new CompactionCommitMessageSerDe();
   ...
   * <p>
   * Method under test: {@link CompactionCommitMessageSerDe#toJson(CompactionCommitMessage)}
   */
  @Test
  ...
  void testToJson() {
    ...
    assertEquals(
        "{\"tableId\":\"42\",\"request\":{\"jobId\":\"42\",\"taskId\":\"42\",\"jobRunId\":\"42\",\"inputFiles\":[],\"newReference\""
            ...
            + "\"onlyContainsDataForThisPartition\":true}}}",
        compactionCommitMessageSerDe.toJson(new CompactionCommitMessage("42", request)));
  }
  ...
  void testToJson2() {
    ...
    assertEquals(
        "{\"tableId\":\"\",\"request\":{\"jobId\":\"42\",\"taskId\":\"42\",\"jobRunId\":\"42\",\"inputFiles\":[],\"newReference\":{"
            + "\"filename\":\"foo.txt\",\"partitionId\":\"42\",\"numberOfRecords\":1,\"jobId\":\"42\",\"countApproximate\":true,"
            + "\"onlyContainsDataForThisPartition\":true}}}",
        compactionCommitMessageSerDe.toJson(new CompactionCommitMessage("", request)));
  }
   ...
   */
  @Test
  @DisplayName("Test toJson(CompactionCommitMessage); given '42'; when ArrayList() add '42'; then return a string")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String CompactionCommitMessageSerDe.toJson(CompactionCommitMessage)"})
   ...
   */
  @Test
  @DisplayName("Test toJson(CompactionCommitMessage); given 'foo'; when ArrayList() add 'foo'; then return a string")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String CompactionCommitMessageSerDe.toJson(CompactionCommitMessage)"})
   ...
   * <p>
   * Method under test: {@link CompactionCommitMessageSerDe#toJsonPrettyPrint(CompactionCommitMessage)}
   */
  @Test
  @DisplayName("Test toJsonPrettyPrint(CompactionCommitMessage)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String CompactionCommitMessageSerDe.toJsonPrettyPrint(CompactionCommitMessage)"})
  void testToJsonPrettyPrint() {
    ...
    assertEquals(
        "{\n" + "  \"tableId\": \"42\",\n" + "  \"request\": {\n" + "    \"jobId\": \"42\",\n"
            ...
            + "      \"onlyContainsDataForThisPartition\": true\n" + "    }\n" + "  }\n" + "}",
        compactionCommitMessageSerDe.toJsonPrettyPrint(new CompactionCommitMessage("42", request)));
  }
  ...
  void testToJsonPrettyPrint2() {
    ...
    assertEquals(
        "{\n" + "  \"tableId\": \"\",\n" + "  \"request\": {\n" + "    \"jobId\": \"42\",\n"
            ...
            + "      \"numberOfRecords\": 1,\n" + "      \"jobId\": \"42\",\n" + "      \"countApproximate\": true,\n"
            + "      \"onlyContainsDataForThisPartition\": true\n" + "    }\n" + "  }\n" + "}",
        compactionCommitMessageSerDe.toJsonPrettyPrint(new CompactionCommitMessage("", request)));
  }
   ...
   */
  @Test
  @DisplayName("Test toJsonPrettyPrint(CompactionCommitMessage); given '42'; when ArrayList() add '42'; then return a string")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String CompactionCommitMessageSerDe.toJsonPrettyPrint(CompactionCommitMessage)"})
   ...
   */
  @Test
  @DisplayName("Test toJsonPrettyPrint(CompactionCommitMessage); given 'foo'; when ArrayList() add 'foo'; then return a string")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"String CompactionCommitMessageSerDe.toJsonPrettyPrint(CompactionCommitMessage)"})
