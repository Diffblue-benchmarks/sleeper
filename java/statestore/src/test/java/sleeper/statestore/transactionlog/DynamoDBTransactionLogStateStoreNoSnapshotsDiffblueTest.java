...
class DynamoDBTransactionLogStateStoreNoSnapshotsDiffblueTest {
  /**
   * Test {@link DynamoDBTransactionLogStateStoreNoSnapshots#builderFrom(InstanceProperties, TableProperties, AmazonDynamoDB, AmazonS3)}.
   * <ul>
   *   <li>Then calls {@link SleeperPropertyValues#getInt(SleeperProperty)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DynamoDBTransactionLogStateStoreNoSnapshots#builderFrom(InstanceProperties, TableProperties, AmazonDynamoDB, AmazonS3)}
   */
  @Test
  @DisplayName("Test builderFrom(InstanceProperties, TableProperties, AmazonDynamoDB, AmazonS3); then calls getInt(SleeperProperty)")
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({
      "sleeper.core.statestore.transactionlog.TransactionLogStateStore.Builder DynamoDBTransactionLogStateStoreNoSnapshots.builderFrom(InstanceProperties, TableProperties, AmazonDynamoDB, AmazonS3)"})
  void testBuilderFrom_thenCallsGetInt() {
    ...
    // Act
    DynamoDBTransactionLogStateStoreNoSnapshots.builderFrom(instanceProperties, tableProperties, dynamoDB,
        new AmazonS3Client());
