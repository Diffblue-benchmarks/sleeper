...
class DynamoDBIngestTaskTrackerCreatorDiffblueTest {
  /**
   * Test {@link DynamoDBIngestTaskTrackerCreator#create(InstanceProperties, AmazonDynamoDB)}.
   * <ul>
   *   <li>Given {@code false}.</li>
   *   <li>When {@link InstanceProperties} {@link SleeperPropertyValues#getBoolean(SleeperProperty)} return {@code false}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DynamoDBIngestTaskTrackerCreator#create(InstanceProperties, AmazonDynamoDB)}
   */
  @Test
  ...
  @MethodsUnderTest({"void DynamoDBIngestTaskTrackerCreator.create(InstanceProperties, AmazonDynamoDB)"})
  void testCreate_givenFalse_whenInstancePropertiesGetBooleanReturnFalse() {
    ...
    // Act
    DynamoDBIngestTaskTrackerCreator.create(properties, mock(AmazonDynamoDBAsyncClient.class));
  ...
  void testCreate_thenCallsCreateTable() {
    ...
    // Act
    DynamoDBIngestTaskTrackerCreator.create(properties, dynamoDB);
  ...
  /**
   * Test {@link DynamoDBIngestTaskTrackerCreator#tearDown(InstanceProperties, AmazonDynamoDB)}.
   * <ul>
   *   <li>Given {@link DeleteTableResult} (default constructor).</li>
   *   <li>Then calls {@link AmazonDynamoDBClient#deleteTable(String)}.</li>
   * </ul>
   * <p>
   * Method under test: {@link DynamoDBIngestTaskTrackerCreator#tearDown(InstanceProperties, AmazonDynamoDB)}
   */
  @Test
  ...
  @Tag("MaintainedByDiffblue")
  @MethodsUnderTest({"void DynamoDBIngestTaskTrackerCreator.tearDown(InstanceProperties, AmazonDynamoDB)"})
  void testTearDown_givenDeleteTableResult_thenCallsDeleteTable() {
    ...
    // Act
    DynamoDBIngestTaskTrackerCreator.tearDown(properties, dynamoDBClient);

    // Assert
    verify(dynamoDBClient).deleteTable(eq("sleeper-Get-ingest-task-status"));
    verify(properties).getBoolean(isA(InstanceProperty.class));
    verify(properties).get(isA(InstanceProperty.class));
  }
  ...
  void testTearDown_givenFalse_whenInstancePropertiesGetBooleanReturnFalse() {
    ...
    // Act
    DynamoDBIngestTaskTrackerCreator.tearDown(properties, mock(AmazonDynamoDBAsyncClient.class));
